...
file_in_vi = '//10.0.1.252/nr_working/shared/PhenoRice/Documentes/Paper/mirco/data/Phenorice_dataset_vis.csv'

data_in = read.csv2(file_in, header = T)
data_in_vi = read.csv2(file_in_vi, header = T)
names(data_in)
