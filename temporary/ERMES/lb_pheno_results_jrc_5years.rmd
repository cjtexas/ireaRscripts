...
shapefile = str_replace_all("/home/lb/ermes/data_processing/x_jrc/Shapefiles/fiveyears/%cc%/ERMES_Rice_Statistics.shp","%cc%",country)
  print(shapefile)
  data_shape= lb_openshape(shapefile)
...
```{r shapesanomalies, echo=FALSE, fig.height=17.0, fig.width = 12.75, message=FALSE, warning=FALSE, results="hide"}
  ...
  # data_shape= lb_openshape("/home/lb/projects/ermes/datasets/rs_products/Phenology/IT/Outputs/ERMES_Grid/Statistics/Shapefiles/ERMES_Rice_Statistics.shp")
