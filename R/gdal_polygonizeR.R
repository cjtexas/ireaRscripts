...
#'
#' @param x          filename of a raster file, or "R" raster object
#' @param outshape   filename of the desireed output polygon fishnet
#' @param gdalformat defaults to ESRI - don't change
#' @param pypath     path of python  - automatically retrieved
